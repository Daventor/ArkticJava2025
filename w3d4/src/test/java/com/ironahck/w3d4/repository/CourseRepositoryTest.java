...
class CourseRepositoryTest {
    ...
    @Test
    public void findSumHours_hoursSum(){
    ...
    @Test
    public void findHoursAndClassroomOnObject_propertyHoursAndClassroom(){
        List<Object[]> result = courseRepository.findHoursAndClassroomOnObject();
